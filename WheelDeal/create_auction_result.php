...
/* TODO #3: If everything looks good, make the appropriate call to insert
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO Item (title, details, itemCondition, tags, startPrice, reservePrice, itemImage)
    VALUES ('$auctionTitle', '$auctionDetails', '$itemCondition', '$itemTags', '$auctionStartPrice', '$auctionReservePrice', '/Pictures123/bike.png')";
