...
('Bike Light - USB Rechargeable', 'This USB Rechargeable Bike Light is a must for night rides. It\'s bright and has a long-lasting battery, making it a handy accessory for any cyclist.', '2025-01-05 18:00:00', '2025-01-15 18:00:00', 20, 25, 'Brand New', 'image_uploads/51fPcqtPr5L._AC_SL1000_.jpg', 'light, USB, accessories', (SELECT userId FROM `User` WHERE username = 'bikeenthusiast'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Accessories')),
...
('Cycling Shorts - Padded', 'These padded cycling shorts are made for comfort. They help reduce chafing and are made from breathable fabric for a snug fit.', '2025-01-12 18:00:00', '2025-01-22 18:00:00', 5,5, 'Brand New', 'image_uploads/paddedShorts.jpg', 'shorts, apparel, padded', (SELECT userId FROM `User` WHERE username = 'mountainmaverick'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Apparel')),
