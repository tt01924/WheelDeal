...
('Mountain Bike - Rockrider', 'Great for trail adventures, this Mountain Bike - Rockrider has a sturdy frame and reliable parts. It\'s suitable for both beginners and those with some experience who enjoy off-road biking.', '2024-10-01 18:00:00', '2024-12-10 18:00:00', 180, 200, 'Used - Good Condition', 'image_uploads/btwin-rockrider-500-mountain-bike-rockrider-500-mountain-bike-2017_2-large.jpg', 'mountain bike, Rockrider, trails', (SELECT userId FROM `User` WHERE username = 'mountainmaverick'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Bikes')),
...
('Cycling Helmet - Giro Air', 'Stay safe with the Cycling Helmet - Giro Air. It\'s lightweight and has good ventilation to keep you cool. Suitable for both casual and serious cyclists.', '2024-12-10 18:00:00', '2024-12-20 18:00:00', 15, 20, 'Brand New', 'image_uploads/244324_7510_XL.jpg', 'helmet, safety, accessories', (SELECT userId FROM `User` WHERE username = 'bikeenthusiast'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Apparel')),
('Clipless Pedals - Shimano SPD', 'These Clipless Pedals - Shimano SPD help you pedal more efficiently. They connect your shoes to the bike for better power and control, great for road and mountain biking.', '2024-12-12 18:00:00', '2024-12-22 18:00:00', 30, 45, 'Used - Excellent Condition', 'image_uploads/61zmTWjA0RL._AC_SL1200_.jpg', 'pedals, Shimano, parts', (SELECT userId FROM `User` WHERE username = 'bikeenthusiast'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Parts')),
('Cycling Gloves - Full Finger', 'These full-finger cycling gloves are comfortable and protective. They have breathable fabric and padded palms to help reduce hand fatigue on long rides.', '2024-12-15 18:00:00', '2024-12-25 18:00:00', 10, 20, 'Brand New', 'image_uploads/6550b97c71887240a509b04fe02bb89333439556f161e4f0b6716.jpg', 'gloves, apparel, full finger', (SELECT userId FROM `User` WHERE username = 'mountainmaverick'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Apparel')),
...
('Mountain Bike Tire - Maxxis High Roller', 'This Mountain Bike Tire - Maxxis High Roller is great for tough trails. It has a strong tread for good grip on loose surfaces, perfect for those who want durability.', '2024-12-25 18:00:00', '2025-01-04 18:00:00', 20, 30, 'Brand New', 'image_uploads/716RhaTRWdL._AC_SL1500_.jpg', 'tire, Maxxis, parts', (SELECT userId FROM `User` WHERE username = 'bikeenthusiast'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Parts')),
('Cycling Jersey - Reflective', 'Stay visible with this Cycling Jersey - Reflective. It\'s made from breathable fabric and has reflective parts for safety in low light, ensuring a comfy fit for long rides.', '2024-12-30 18:00:00', '2025-01-09 18:00:00', 50, 60, 'Brand New', 'image_uploads/71pxvQeyNML._AC_SX679_.jpg', 'jersey, reflective, apparel', (SELECT userId FROM `User` WHERE username = 'mountainmaverick'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Apparel')),
...
('Bike Light - USB Rechargeable', 'This USB Rechargeable Bike Light is a must for night rides. It\'s bright and has a long-lasting battery, making it a handy accessory for any cyclist.', '2025-01-05 18:00:00', '2025-01-15 18:00:00', 5, 7, 'Brand New', 'image_uploads/51fPcqtPr5L._AC_SL1000_.jpg', 'light, USB, accessories', (SELECT userId FROM `User` WHERE username = 'bikeenthusiast'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Accessories')),
...
('Cycling Shorts - Padded', 'These padded cycling shorts are made for comfort. They help reduce chafing and are made from breathable fabric for a snug fit.', '2025-01-12 18:00:00', '2025-01-22 18:00:00', 5,7, 'Brand New', 'image_uploads/paddedShorts.jpg', 'shorts, apparel, padded', (SELECT userId FROM `User` WHERE username = 'mountainmaverick'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Apparel')),
('Mountain Bike Frame - Aluminum', 'This Aluminum Mountain Bike Frame is lightweight and strong, perfect for building your own bike. It\'s great for those looking to upgrade.', '2025-01-14 18:00:00', '2025-01-24 18:00:00', 120, 150, 'Used - Excellent Condition', 'image_uploads/mtb-frame.jpg', 'frame, mountain bike, parts', (SELECT userId FROM `User` WHERE username = 'bikeenthusiast'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Parts')),
('Bike Bell - Classic', 'The Classic Bike Bell is a nice touch for any bike. It\'s loud and easy to install, adding a bit of nostalgia to your ride.', '2024-10-10 18:00:00', '2024-11-10 18:00:00', 8, 10, 'Brand New', 'image_uploads/bike-bell.jpg', 'bell, accessories, classic', (SELECT userId FROM `User` WHERE username = 'freerider'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Accessories')),
('Water Bottle Holder - Adjustable', 'This Adjustable Water Bottle Holder fits different bottle sizes and is easy to install. It\'s a useful accessory for staying hydrated on the go.', '2025-01-18 18:00:00', '2025-01-28 18:00:00', 10, 15, 'Brand New', 'image_uploads/water-bottle-holder.jpeg', 'holder, accessories, adjustable', (SELECT userId FROM `User` WHERE username = 'freerider'), (SELECT categoryId FROM `ItemCategory` WHERE categoryName = 'Accessories'));
